...
export const translations: NestedPartialAsStrings<Translations> = {
  ...
  reports: {
    ...
    selectDates: "Berichtstage",
    allDates: "Alle Tage",
    today: "Heute",
    yesterday: "Gestern",
    last7Days: "Letzte 7 Tage",
    selectedDatesCount: "{{count}} Tage ausgewählt",
    noDatesAvailable: "Keine Buchungstage verfügbar",
    dayMode: "Tagesdefinition",
    calendarDay: "Kalendertag",
    eventDay: "Veranstaltungstag",
    calendarDayHint: "Berücksichtigt Buchungen von 00:00 bis 24:00 Uhr.",
    eventDayHint: "Der Berichtstag beginnt und endet um {{time}} Uhr.",
    eventDayUnavailable: "Für die Veranstaltung ist keine tägliche Endzeit konfiguriert.",
