export const translations = {
  ...
  reports: {
    ...
    selectDates: "Report days",
    allDates: "All days",
    today: "Today",
    yesterday: "Yesterday",
    last7Days: "Last 7 days",
    selectedDatesCount: "{{count}} days selected",
    noDatesAvailable: "No booking days available",
    dayMode: "Day definition",
    calendarDay: "Calendar day",
    eventDay: "Event day",
    calendarDayHint: "Includes bookings from midnight to midnight.",
    eventDayHint: "The report day starts and ends at {{time}}.",
    eventDayUnavailable: "No daily end time is configured for this event.",
